...
public class ShowActivity extends BaseActivity {
    ...
    public static List<ResSize> resList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iIniHanlder.Init(Paras.appContext, null);
        ...
        Runnable programTask=new Runnable() {
            @Override
            public void run() {
        ...
        Paras.executor.scheduleAtFixedRate(programTask,5,5, TimeUnit.SECONDS);
        ...
        Paras.executor.scheduleAtFixedRate(FreshThread,10,5,TimeUnit.SECONDS);
        Paras.executor.scheduleAtFixedRate(KeepFocusThread,10000,500,TimeUnit.MILLISECONDS);
    }
    @Override
                                            ...
                                            try {
                                                if(Paras.devType.equals(Paras.DEVA40_XiPin)) {
                                                    ...
                                                    if(!url.toString().equals(Paras.programUrl)||!wvUrl.toString().equals(Paras.underUrl)) {
                                                        webView2.loadUrl(url.toString());
                                                        webView1.loadUrl(wvUrl.toString());
                                                        /*webView2.loadUrl(wvUrl.toString());
